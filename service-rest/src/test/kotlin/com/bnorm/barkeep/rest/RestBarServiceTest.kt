...
class RestBarServiceTest : AbstractRestServiceTest() {
  ...
  fun createBar_successful() {
    // given
    val bar = BarValue(title = "Bar1", description = "Description1")
  ...
  fun getBar_successful() {
    // given
    val bar = service.createBar(BarValue(title = "Bar1", description = "Description1")).execute().body()
  ...
  fun updateBar_successful_withValidBodyId() {
    ...
    // when
    val response = service.updateBar(bar.id, BarValue(title = "Bar2")).execute()
  ...
  fun updateBar_successful_withInvalidBodyId() {
    ...
    // when
    val response = service.updateBar(bar.id, BarValue(title = "Bar2", description = "Description2")).execute()
  ...
  fun updateBar_failure_badId() {
    ...
    // when
    val response = service.updateBar(-1, BarValue(title = "Bar1", description = "Description1")).execute()
  ...
  fun getBars_successful_emptyAfterDelete() {
    // given
    val bar1 = service.createBar(BarValue(title = "Bar1", description = "Description1")).execute().body()
  ...
  fun getBars_successful_singleAfterDelete() {
    // given
    val bar1 = service.createBar(BarValue(title = "Bar1", description = "Description1")).execute().body()
    val bar2 = service.createBar(BarValue(title = "Bar2", description = "Description2")).execute().body()
    val bar3 = service.createBar(BarValue(title = "Bar3", description = "Description3")).execute().body()
    service.deleteBar(bar1.id).execute()
  ...
  fun getBars_successful_multipleAfterDelete() {
    // given
    val bar5 = service.createBar(BarValue(title = "Bar5", description = "Description5")).execute().body()
    val bar3 = service.createBar(BarValue(title = "Bar3", description = "Description3")).execute().body()
    val bar2 = service.createBar(BarValue(title = "Bar2", description = "Description2")).execute().body()
    val bar4 = service.createBar(BarValue(title = "Bar4", description = "Description4")).execute().body()
    val bar1 = service.createBar(BarValue(title = "Bar1", description = "Description1")).execute().body()
