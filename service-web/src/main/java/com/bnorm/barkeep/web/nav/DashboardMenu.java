...
public final class DashboardMenu extends CustomComponent {
  ...
  private Component buildBadgeWrapper(Component menuItemButton, Component badgeLabel) {
  ...
  public void attach() {
    super.attach();
    //    updateNotificationsCount(new DashboardEvent.NotificationsCountUpdatedEvent(2));
  }

  @Subscribe
  public void postViewChange(DashboardEvent.PostViewChangeEvent event) {
  ...
  public void updateNotificationsCount(DashboardEvent.NotificationsCountUpdatedEvent event) {
    int unreadNotificationsCount = event.getCount();
    notificationsBadge.setValue(String.valueOf(unreadNotificationsCount));
    notificationsBadge.setVisible(unreadNotificationsCount > 0);
  }

  @Subscribe
  public void updateReportsCount(DashboardEvent.ReportsCountUpdatedEvent event) {
    reportsBadge.setValue(String.valueOf(event.getCount()));
    reportsBadge.setVisible(event.getCount() > 0);
  }

  @Subscribe
  public void updateUserName(DashboardEvent.ProfileUpdatedEvent event) {
    User user = VaadinSession.getCurrent().getAttribute(User.class);
    settingsItem.setText(user.getDisplayName());
  }
  ...
  public final class ValoMenuItemButton extends Button {
    ...
    public ValoMenuItemButton(DashboardViewType view) {
      this.view = view;
