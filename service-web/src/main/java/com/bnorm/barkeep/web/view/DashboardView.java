...
import com.bnorm.barkeep.web.DashboardNotification;
...
public final class DashboardView extends Panel implements View {
  ...
  private void openNotificationsPopup(final ClickEvent event) {
    ...
    Collection<DashboardNotification> notifications = Collections.emptyList(); //DashboardUI.getDataProvider().getNotifications();
//    DashboardEventBus.post(new DashboardEvent.NotificationsCountUpdatedEvent(2));
...
//    notificationsButton.updateNotificationsCount(new DashboardEvent.NotificationsCountUpdatedEvent(2));
  }
