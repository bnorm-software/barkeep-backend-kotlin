...
interface BarkeepService {
  ...
  @PUT("books/{id}")
  fun updateBook(@Path("id") id: Long, @Body book: Book): Call<Book>
  ...
  @POST("bars")
  fun createBar(@Body bar: Bar): Call<Bar>

  @GET("bars/{id}")
  fun getBar(@Path("id") id: Long): Call<Bar>

  @PUT("bars/{id}")
  fun updateBar(@Path("id") id: Long, @Body bar: Bar): Call<Bar>
  ...
  @POST("ingredients")
  fun createIngredient(@Body ingredient: Ingredient): Call<Ingredient>

  @GET("ingredients/{id}")
  fun getIngredient(@Path("id") id: Long): Call<Ingredient>

  @PUT("ingredients/{id}")
  fun updateIngredient(@Path("id") id: Long, @Body ingredient: Ingredient): Call<Ingredient>
